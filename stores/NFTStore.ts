...
export class NFTStore {
  ...
  //get user data
@action pushToNFTList =async (list:any[], type:string) => {
  if(type == 'pets') {
    this.characters = [...this.characters, ...list]
  } else {
    this.planets = [...this.planets, ...list]
  }
}
          ...
          setTimeout(() => {
            ...
            const getInfo = async () => {
              ...
              if (info && type == "planet") {
                ...
                this.planets[ind2] = {
                  ...this.planets[ind2],
                  ...info.data.result[0].normalized_metadata,
                };
